...
screen.connect_signal("request::desktop_decoration", function(s)
  ...
  s.mywibox = awful.wibar({
    ...
    widget = {
      ...
      {
        layout = wibox.layout.align.horizontal,
        wibox.container.background(wibox.container.margin(s.mytaglist, 1685, 0, 2, 2)),
      },
      { -- Right widgets
        layout = wibox.layout.fixed.horizontal,
        wibox.widget.systray(),
        wibox.container.margin(mytextclock, 0, 50, 0, 0)
      },
    },
  })
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey }, "`", function()
    awful.spawn.with_shell("launcher_t3")
  end, { description = "open rofi launcher", group = "launcher" }),
  awful.key({ modkey }, "v", function()
    awful.spawn.with_shell("powermenu_t1")
  end, { description = "open rofi powermenu", group = "launcher" }),
  awful.key({ modkey }, "b", function()
    awful.spawn.with_shell("brave-browser --password-store=basic")
...
local autorun = true
local autorunApps = {
  -- Run launch commands here for now
